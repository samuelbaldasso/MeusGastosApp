                              ...
                              children: [
                                ...
                                ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      final itemWithCat = cat.firstWhere(
                                          (element) =>
                                              element.id == item.categoryId);

                                      var otherExpensesWithSameCategory =
                                          state.expenses
                                              .where((e) =>
                                                  e.categoryId ==
                                                      itemWithCat.id &&
                                      ...
                                      // If no other expenses reference the category, delete the category
                                        ...
                                        return Dismissible(
                                          ...
                                          onDismissed: (direction) async {
                                            if (direction ==
                                              ...
                                              if (otherExpensesWithSameCategory
                                                  .isEmpty) {
                                                await controller
                                                    .deleteCategory(
                                                        itemWithCat);
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        if (keyEdit.currentState?.validate() ??
                                                                          ...
                                                                          await controller.updateEntry(entryUpdated,
