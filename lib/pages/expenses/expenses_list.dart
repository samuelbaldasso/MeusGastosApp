                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child: Padding(
                                                              ...
                                                              child: ElevatedButton(
                                                                onPressed: () async {
                                                                  await controller.loadExpensesWeek();
                                                                },
                                                          ...
                                                          Expanded(
                                                            child: Padding(
                                                              ...
                                                              child: ElevatedButton(
                                                                onPressed: () async {
                                                                  await controller.loadExpensesMonth();
                                                                },
                                                                style: ElevatedButton.styleFrom(
                                                                  backgroundColor: Colors.white,
                                                                  elevation: 3,
                                                        ...
                                                        return Dismissible(
                                                          ...
                                                          onDismissed: (direction) async {
                                                            if (direction ==
                                                              ...
                                                              // Always delete the expense
                                                              await controller.deleteEntry(item);
                                                  
                                                              var associatedCategory =
                                                                  categoryMap[item.categoryId];
                                                  
                                                              if (associatedCategory != null) {
                                                                // Check if there are no more expenses associated with this category
                                                                var expensesOfCategory = state
                                                                    .expenses
                                                                    .where((expense) =>
                                                                        expense.categoryId ==
                                                                        associatedCategory.id)
                                                                    .toList();
                                                                log(expensesOfCategory
                                                                    .map((e) => e.categoryId)
                                                                    .toString());
                                                  
                                                                if (expensesOfCategory.length == 1) {
                                                                  ...
                                                                  scaffold.showSnackBar(
                                                                    const SnackBar(
                                                                      content: Text(
                                                                          "Gasto e categoria associada excluídas com sucesso"),
                                                                    ),
                                                                  );
                                                                } else {
                                                                  // Just notify about the expense deletion
                                                                  scaffold.showSnackBar(
                                                                    const SnackBar(
                                                                      content: Text(
                                                                ...
                                                                // Notify about the expense deletion when no associated category found
                                                                scaffold.showSnackBar(
                                                                  const SnackBar(
                                                                    content: Text(
                                                                        "Gasto excluído com sucesso"),
