                                                                          ...
                                                                          if (key.currentState?.validate() ??
                                                                            ...
                                                                            await controller.updateEntry(Entry(
                                                                                ...
                                                                                category: Category(
                                                                                  ...
                                                                                  dataAlteracao: state.categories[index].dataAlteracao,
                                                                                  id: state.categories[index].id ?? 0,
                                                                                  dataCriacao: state.categories[index].dataCriacao,
                                                                                  entryType: state.categories[index].entryType,
                                                                                  isChanged: state.categories[index].isChanged,
                                                                                  isInativo: state.categories[index].isInativo,
                                                                                  uid: state.categories[index].uid,
                                                                                  uidFirebase: state.categories[index].uidFirebase,
                                                                                ),
