                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "R\$ ${controller.getTotalIn(state.expenses)}",
                                          style: const TextStyle(
                                            fontSize: 36,
                                            fontWeight: FontWeight.bold,
                                          ),
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "R\$ ${controller.getTotalOut(state.expenses)}",
                                          style: const TextStyle(
                                            fontSize: 36,
                                            fontWeight: FontWeight.bold,
                                          ),
                                                                  ...
                                                                  if (key.currentState
                                                                    ...
                                                                    await controller
                                                                      ...
                                                                      category: state
                                                                          ...
                                                                          Category(
                                                                            name:
                                                                                state.expenses[index].category?.name ?? "",
                                                                            description:
                                                                                state.expenses[index].category?.description ?? "",
                                                                            dataAlteracao:
                                                                                state.expenses[index].category?.dataAlteracao,
                                                                            id: state.expenses[index].category?.id,
                                                                            dataCriacao:
                                                                                state.expenses[index].category?.dataCriacao,
                                                                            entryType:
                                                                                state.expenses[index].category?.entryType,
                                                                            isChanged:
                                                                                state.expenses[index].category?.isChanged,
                                                                            isInativo:
                                                                                state.expenses[index].category?.isInativo,
                                                                            uid:
                                                                                state.expenses[index].category?.uid,
                                                                            uidFirebase:
                                                                                state.expenses[index].category?.uidFirebase,
                                                                          ),
                                                                      categoryId: state
                                                                          .expenses[
                                                                              index]
